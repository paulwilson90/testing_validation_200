...
from calcs import slope_corrected, vapp_corrections, wind_correct_formulated, max_landing_wt_lda, get_torque_limits, max_brake_energy_wt
from calcs import get_oei_climb
...
xls = pd.ExcelFile('Q200 Version Control.xlsx')
